    ...
    <div className="flex flex-col gap-6">
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Welcome to Job Scout</CardTitle>
          <CardDescription>Login to scout for your dream job</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="text-xs text-center text-muted-foreground hover:text-primary">
